        ...
        <div className="flex items-center flex-none flex-row flex-nowrap h-min justify-between overflow-hidden p-0 relative w-full">
          <Card
            className={`bg-[rgb(10,10,10)] ${
              device === "mobile" || device === "tablet" ? "h-auto" : "h-[304px]"
            }  w-full rounded-lg overflow-hidden text-white border-0 relative flex flex-col lg:flex-row`}
          >
            ...
            <div
              className={`relative h-min ${
                device === "mobile" || device === "tablet" ? "mx-5" : "w-[449px] self-end justify-end mr-5 mb-5"
              } `}
            >
